 ...
 *
 * Network initialisation for TI AM67A IPC mode (ZENOH_TI_AM67A_IPC).
 *
 * Replaces zenoh_net_init.c when the build is configured with
 * -DZENOH_TI_AM67A_IPC=ON.  Instead of bringing up the CPSW Ethernet driver,
 ...
 *
 * On Linux, load the rpmsg_net kernel module before running zenoh:
 *
